...
<section class="hero-section" aria-labelledby="hero-title">
    <div class="hero-image-container">
        <img src="/data/uploads/hero_image.png" alt="Peaceful landscape with grassy hillside, stream, and grazing sheep under cloudy s
ky" class="hero-image">
    ...
    <div class="container services-container">
        <div class="services-grid">
            ...
            <a href="#cranio-sacral" class="service-card" aria-label="Learn more about Cranio-Sacral Therapy">
                <div class="service-image">
                    <img src="/data/uploads/cranio_sacral_therapy_square.png" role="presentation">
                    <div class="service-title-overlay">
            ...
            <a href="#somatic-emotional" class="service-card" aria-label="Learn more about Somatic-Emotional Release therapy">
                <div class="service-image">
                    <img src="/data/uploads/jumping.png" role="presentation">
                    <div class="service-title-overlay">
            ...
            <a href="#shamanic-work" class="service-card" aria-label="Learn more about Shamanic Work and core shamanism">
                <div class="service-image">
                    <img src="/data/uploads/fire_without_marshmallows.jpeg" role="presentation">
                    <div class="service-title-overlay">
                        <h3>Shamanic Work</h3>
                    </div>
                </div>
            ...
            <a href="#dynamic-body" class="service-card" aria-label="Learn more about Dynamic Body Balancing">
                <div class="service-image">
                    <img src="/data/uploads/dynamic_body_rebalancing5.png" role="presentation">
                    <div class="service-title-overlay">
            ...
            <a href="#reiki" class="service-card" aria-label="Learn more about Reiki healing practice">
                <div class="service-image">
                    <img src="/data/uploads/somatic_emotional_release.png" role="presentation">
                    <div class="service-title-overlay">
                        <h3>Reiki</h3>
                    </div>
                </div>
