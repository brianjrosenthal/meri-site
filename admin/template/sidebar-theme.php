...
<ul class="snav">
	...
	<li id="sb_components" ><a href="load.php?id=html-components"  <?php check_menu('components'); ?> accesskey="<?php echo find_accesskey(i18n_r('SIDE_COMPONENTS'));?>" ><?php i18n('SIDE_COMPONENTS'); ?></a></li>
